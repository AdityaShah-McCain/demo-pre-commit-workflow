...
resource "azurerm_private_endpoint" "MF_MDI_CC-COSMOSDB-PEP" {
  ...
  private_service_connection {
    ...
    private_connection_resource_id = "/subscriptions/00fd4e23-4277-441c-a413-15574a5467d7/resourceGroups/MF_DM_CC_STORAGE-QA-RG/providers/Microsoft.DocumentDB/databaseAccounts/mf-dm-cc-qa-cosmosdbqa"
