...
resource "azurerm_private_endpoint" "MF_MDI_CC-COSMOSDB-PEP" {
  ...
  private_service_connection {
    ...
    private_connection_resource_id = "/subscriptions/2443452a-115b-445e-97fc-17db1a74c0be/resourceGroups/MF_DM_CC_STORAGE-DEV-RG/providers/Microsoft.DocumentDB/databaseAccounts/mf-dm-cc-dev-cosmosdbdev"
