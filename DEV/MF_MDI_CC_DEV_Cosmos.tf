...
resource "azurerm_cosmosdb_account" "mf-mdi-cc-cosmosdb" {
  ...
  network_acl_bypass_ids                = ["/subscriptions/6b5fafad-c388-4834-8e16-daf9828deb84/resourceGroups/MF_GDA_Synapse_QA-RG/providers/Microsoft.Synapse/workspaces/azure-synapse-workspace-01-qa"]
...
# resource "azurerm_cosmosdb_sql_database" "MDIxAI_DEV" {
...
#   resource_group_name    = azurerm_resource_group.MF_MDI_CC_STORAGE-RG.name
#   account_name           = azurerm_cosmosdb_account.mf-mdi-cc-cosmosdb.name
#   database_name          = azurerm_cosmosdb_sql_database.MDIxAI_DEV.name
