resource "azurerm_app_service_plan" "MF_MDI_CC_CORE-LASP" {
    name                    = var.MF_DM_CC_CORE-DEV-logicappSP_Name
...
resource "azurerm_logic_app_standard" "MF-MDI-CC-CORE-LogicappSAP" {
    name                = var.MF-DM-CC-CORE-DEV-Logicappsap_Name
    resource_group_name = azurerm_resource_group.MF_MDI_CC-RG.name
    location            = azurerm_resource_group.MF_MDI_CC-RG.location
  ...
  body = {
    ...
    properties = {
      ...
      parameterValues       = {
          ...
          authType= "basic",
          userName= "BTCDMAPPS",
          password= "PA$)9PB{5vvX@#>$RmE=h~P94cujS8c/e$7d{]Zi"
          gateway= {
              "name": "PowerPlatform-Azure-Onprem-MDIAI-Datagateway-Dev",
              "id": "/subscriptions/6b5fafad-c388-4834-8e16-daf9828deb84/resourceGroups/MF_PowerBI_Dev-RG/providers/Microsoft.Web/connectionGateways/PowerPlatform-Azure-Onprem-MDIAI-Datagateway-Dev",
          ...
          messageServerService= "",
		      logonGroup= "",
		      systemID= "",
          appServerHost= "sap5sna01.mccain.com"
      }
    //  parameterValues       = {
    //       sncQop= "Authentication",
    //       sncSso= "On",
